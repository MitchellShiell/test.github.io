...
Biomedical data requires secure methods for authenticating users and authorizing the information and applications those users can access. [Ego](https://www.overture.bio/products/ego/) addresses this issue by facilitating user registration and providing a secure permission management system. 
